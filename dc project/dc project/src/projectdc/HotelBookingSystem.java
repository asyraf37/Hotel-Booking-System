...
public class HotelBookingSystem extends JFrame {
    ...
    public HotelBookingSystem() {
        ...
        userIDLabel = new JLabel("Booking ID:");
        ...
        submitButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    oos.flush();
                    System.out.println("Sent Booking information to the server.");
                         JOptionPane.showMessageDialog(null, "Sent Booking information to the server.", "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String[] args) {
        HotelBookingSystem fr = new HotelBookingSystem();
        fr.setVisible(true);
    }
}